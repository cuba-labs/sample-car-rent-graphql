...
public class ScrTestContainer extends TestContainer {

    public ScrTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/scr/app.properties",
    ...
    public static class Common extends ScrTestContainer {

        public static final ScrTestContainer.Common INSTANCE = new ScrTestContainer.Common();
