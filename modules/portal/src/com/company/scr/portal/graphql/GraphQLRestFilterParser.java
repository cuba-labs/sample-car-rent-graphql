 ...
 */
public class GraphQLRestFilterParser {
    ...
    private final Logger log = LoggerFactory.getLogger(GraphQLRestFilterParser.class);
    ...
    public RestFilterParseResult parse(String filterJson, MetaClass metaClass) throws RestFilterParseException {
        ...
        if (group != null) {
            try {
                type = RestFilterGroupCondition.Type.valueOf(group.getAsString().toUpperCase());
            } catch (IllegalArgumentException e) {
                throw new RestFilterParseException("Invalid conditions group type: " + group.getAsString());
            }
        }
